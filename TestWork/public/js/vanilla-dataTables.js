...
(function(root, factory) {
    ...
    var defaultConfig = {
        ...
        labels: {
            placeholder: "Поиск...", //"Search...", // The search input placeholder
            perPage: "{select}", //  элементов на странице "{select} entries per page", // per-page dropdown label
            noRows: "Элементов не найдено", //"No entries found", // Message shown when there are no search results
            info: "Показано с {start} по {end} из {rows} элементов", //"Showing {start} to {end} of {rows} entries" //
        },
    ...
    proto.render = function (type) {
        ...
        if (o.perPageSelect) {
            ...
            var select = createElement("select", {
                class: "uk-select uk-form-width-xsmall dataTable-selector "
            });
        ...
        if (o.searchable) {
            var form =
                "<div class='dataTable-search'><input class='uk-input dataTable-input ' placeholder='" +
